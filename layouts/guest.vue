<template>
    <div class="font-sans bg-white flex flex-col min-h-screen w-full" style="background-image: url('https://www.toptal.com/designers/subtlepatterns/uploads/dot-grid.png');">
        <div id="header">
            <div class="bg-gray-200 px-4 py-4">
                <div class="w-full md:max-w-6xl md:mx-auto md:flex md:items-center md:justify-between">
                    <div>
                        <a href="#" class="inline-block py-2 text-gray-800 text-2xl font-bold">NEC</a>
                    </div>

                    <div>
                        <div class="hidden md:block">
                            <a href="#" class="inline-block py-1 md:py-4 text-gray-600 mr-6 font-bold">Beranda</a>
                            <a href="#"
                                class="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-600 mr-6">Blog</a>
                            <a href="#"
                                class="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-600 mr-6">Gallery</a>
                            <a href="#"
                                class="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-600 mr-6">Penghargaan</a>
                        </div>
                    </div>
        ...
        <footer class="bg-gradient-to-r from-gray-100 via-sky-500/50 to-gray-100">
            <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <img src="@/assets/logo/nec.png" class="mr-5 h-10 sm:h-16" alt="logo" />
