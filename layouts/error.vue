<template>
    <div>
        <div class="min-w-screen min-h-screen bg-blue-100 flex items-center p-5 lg:p-10 overflow-hidden relative">
            <div
                class="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-10 text-gray-800 relative md:flex items-center text-center md:text-left">
                <div class="w-full md:w-1/2">
                    <div class="mb-10 lg:mb-20">
                        <img src="@/assets/logo/nec.png" class="w-48" alt="logo">
                    </div>
                    <div class="mb-10 md:mb-20 text-gray-600 font-light">
                        <h1 class="font-black uppercase text-3xl lg:text-5xl text-gray-500 mb-10">Sepertinya kamu tersesat ?</h1>
                        <p>Halaman yang kamu cari gaada loh....</p>
                        <p>Kayaknya ada typo saat mengetikan alamat url.</p>
                    </div>
                </div>
